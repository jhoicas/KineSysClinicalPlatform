        ...
        <div className="flex items-center justify-center gap-10 md:gap-16 w-full max-w-xl">
          ...
          <div className="relative flex flex-col items-center">
            ...
            <div className="relative w-44 h-96 flex items-center justify-center select-none">
              {/* Female Athletic SVG Silhouette - Front */}
              <svg
                viewBox="0 0 100 220"
              ...
              >
                ...
                {/* Head */}
                <ellipse cx="50" cy="18" rx="10" ry="13" fill="url(#bodySkinFront)" />
                {/* Neck */}
                ...
                <path
                  d="M74 50 C77 60 80 75 80 92 C80 102 78 112 77 118 C76 122 73 124 72 120 C71 114 74 100 73 90 C72 82 71 72 70 66 Z"
                  fill="url(#bodySkinFront)"
                />
                {/* Right Arm (viewer left) */}
                <path
                  d="M26 50 C23 60 20 75 20 92 C20 102 22 112 23 118 C24 122 27 124 28 120 C29 114 26 100 27 90 C28 82 29 72 30 66 Z"
                  fill="url(#bodySkinFront)"
                />
                {/* Sports Top Bra (matching mockup) */}
                <path
                  d="M40 40 Q50 48 60 40 L64 62 Q50 67 36 62 Z"
                  fill="url(#sportsAttire)"
                />
                {/* Sports Shorts (matching mockup) */}
                <path
                  d="M38 98 Q50 96 62 98 L65 124 L52 124 L50 112 L48 124 L35 124 Z"
                  fill="url(#sportsAttire)"
                />
                {/* Legs Front */}
                {/* Right Leg (viewer left) */}
                <path
                  d="M35 124 C34 135 34 150 37 165 C38 172 39 179 38 188 C37 196 36 205 35 212 C35 215 39 216 41 214 C43 208 44 196 44 186 C44 175 46 162 46 150 C46 138 48 126 50 114 Z"
                  fill="url(#bodySkinFront)"
                />
                {/* Left Leg (viewer right) */}
                <path
                  d="M65 124 C66 135 66 150 63 165 C62 172 61 179 62 188 C63 196 64 205 65 212 C65 215 61 216 59 214 C57 208 56 196 56 186 C56 175 54 162 54 150 C54 138 52 126 50 114 Z"
                  fill="url(#bodySkinFront)"
                />
                {/* Navel / Anatomical hints */}
          ...
          <div className="relative flex flex-col items-center">
            ...
            <div className="relative w-44 h-96 flex items-center justify-center select-none">
              ...
              >
                ...
                {/* Head (Hair/Back) */}
                <ellipse cx="50" cy="18" rx="10" ry="13" fill="url(#bodySkinBack)" />
                <path d="M43 14 C43 25 57 25 57 14 Z" fill="#475569" opacity="0.3" />
                {/* Neck */}
                <path d="M46 30 L46 36 L54 36 L54 30 Z" fill="url(#bodySkinBack)" />
                {/* Spine groove indication */}
                <line x1="50" y1="38" x2="50" y2="92" stroke="#64748B" strokeWidth="0.8" strokeDasharray="2 3" opacity="0.4" />
                {/* Back Torso */}
                <path
                  d="M46 36 C35 38 28 44 26 50 C24 57 23 70 23 78 C23 83 26 84 27 80 L28 65 C32 68 36 70 38 78 C40 85 41 94 40 100 C39 105 38 108 34 114 C30 119 32 125 35 125 L49 125 L51 125 L65 125 C68 125 70 119 66 114 C62 108 61 105 60 100 C59 94 60 85 62 78 C64 70 68 68 72 65 L73 80 C74 84 77 83 77 78 C77 70 76 57 74 50 C72 44 65 38 54 36 Z"
                ...
                <path
                  ...
                  fill="url(#bodySkinBack)"
                />
                {/* Sports Top Back Cross */}
                <path
                  d="M42 40 L58 40 L60 62 L40 62 Z"
                  fill="#0F172A"
                />
                {/* Sports Shorts Back */}
                <path
                  d="M38 98 Q50 96 62 98 L65 124 L52 124 L50 116 L48 124 L35 124 Z"
                  fill="#0F172A"
                />
                {/* Legs Back */}
                <path
