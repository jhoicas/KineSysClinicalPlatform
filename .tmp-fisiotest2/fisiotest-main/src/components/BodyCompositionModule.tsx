...
import { Patient, BodyCompositionBIA, RangeIndicator } from '../types';
import {
  Activity,
  Zap,
  RefreshCw,
...
export const BodyCompositionModule: React.FC<BodyCompositionModuleProps> = ({
  ...
  // Calculate BMI
  const heightM = (patient.heightCm || 158.1) / 100;
              ...
              <div className="relative w-44 h-88 flex items-center justify-center">
                ...
                >
                  ...
                  <g clipPath="url(#leftHalf)" fill="url(#splitMuscle)" opacity="0.9">
                    ...
                    <path d="M46 36 C35 38 28 44 26 50 C24 57 23 70 23 78 C23 83 26 84 27 80 L28 65 C32 68 36 70 38 78 C40 85 41 94 40 100 C39 105 38 108 34 114 C30 119 32 125 35 125 L49 125 L51 125 L65 125 C68 125 70 119 66 114 C62 108 61 105 60 100 C59 94 60 85 62 78 C64 70 68 68 72 65 L73 80 C74 84 77 83 77 78 C77 70 76 57 74 50 C72 44 65 38 54 36 Z" />
                    <path d="M26 50 C23 60 20 75 20 92 C20 102 22 112 23 118 C24 122 27 124 28 120 C29 114 26 100 27 90 C28 82 29 72 30 66 Z" />
                    <path d="M74 50 C77 60 80 75 80 92 C80 102 78 112 77 118 C76 122 73 124 72 120 C71 114 74 100 73 90 C72 82 71 72 70 66 Z" />
                    <path d="M35 124 C34 135 34 150 37 165 C38 172 39 179 38 188 C37 196 36 205 35 212 C35 215 39 216 41 214 C43 208 44 196 44 186 C44 175 46 162 46 150 C46 138 48 126 50 114 Z" />
                    <path d="M65 124 C66 135 66 150 63 165 C62 172 61 179 62 188 C63 196 64 205 65 212 C65 215 61 216 59 214 C57 208 56 196 56 186 C56 175 54 162 54 150 C54 138 52 126 50 114 Z" />
                  </g>
