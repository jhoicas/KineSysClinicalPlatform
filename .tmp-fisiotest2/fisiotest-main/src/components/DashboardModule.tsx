...
export const DashboardModule: React.FC<DashboardModuleProps> = ({
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      {/* Perfil de Nutrición & Antropometría Clínica (ISAK) Overview */}
      <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-xs space-y-4">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="font-bold text-base text-slate-900">
                Perfil de Nutrición & Composición Corporal (ISAK Nivel 3)
              </h3>
              <p className="text-2xs text-slate-500">
                Protocolo ISAK, Bioimpedancia InBody H30 y Planificación Dietética TCA 2018
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {/* Card 1: Antropometría ISAK */}
          <div
            onClick={() => onNavigateTo('anthropometry')}
            className="p-4 rounded-xl bg-slate-50 hover:bg-slate-100/80 border border-slate-200/80 transition-all cursor-pointer group flex flex-col justify-between"
          >
            <div>
              <div className="flex items-center justify-between mb-2">
                <span className="text-2xs font-bold text-blue-700 bg-blue-50 px-2 py-0.5 rounded-md border border-blue-100">
                  ISAK 1
                </span>
                <Ruler className="w-4 h-4 text-blue-600 group-hover:scale-110 transition-transform" />
              </div>
              <h4 className="font-bold text-xs text-slate-900">Pliegues & Somatotipo</h4>
              <p className="text-xl font-black text-slate-900 mt-1">22,1 % <span className="text-2xs font-bold text-emerald-700 font-sans">Grasa (Faulkner)</span></p>
              <p className="text-2xs text-slate-500 mt-1">Somatotipo: <strong>Mesomorfo</strong> (Heath-Carter)</p>
            </div>
            <div className="mt-3 pt-2 border-t border-slate-200 flex items-center justify-between text-2xs font-bold text-blue-600">
              <span>Abrir Antropometría</span>
              <ArrowRight className="w-3.5 h-3.5" />
            </div>
          </div>

          {/* Card 2: BIA InBody / Withings */}
          <div
            onClick={() => onNavigateTo('bodycomposition')}
            className="p-4 rounded-xl bg-slate-50 hover:bg-slate-100/80 border border-slate-200/80 transition-all cursor-pointer group flex flex-col justify-between"
          >
            <div>
              <div className="flex items-center justify-between mb-2">
                <span className="text-2xs font-bold text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded-md border border-emerald-100">
                  InBody H30
                </span>
                <Scale className="w-4 h-4 text-emerald-600 group-hover:scale-110 transition-transform" />
              </div>
              <h4 className="font-bold text-xs text-slate-900">Composición Segmental BIA</h4>
              <p className="text-xl font-black text-slate-900 mt-1">21,5 kg <span className="text-2xs font-bold text-blue-600 font-sans">Músculo Esquelético</span></p>
              <p className="text-2xs text-slate-500 mt-1">Agua: <strong>29,4 L</strong> • Grasa Visceral: <strong>Nivel 6</strong></p>
            </div>
            <div className="mt-3 pt-2 border-t border-slate-200 flex items-center justify-between text-2xs font-bold text-emerald-700">
              <span>Abrir Composición</span>
              <ArrowRight className="w-3.5 h-3.5" />
            </div>
          </div>

          {/* Card 3: Minuta TCA 2018 & Presupuesto COP */}
          <div
            onClick={() => onNavigateTo('nutritionplan')}
            className="p-4 rounded-xl bg-slate-50 hover:bg-slate-100/80 border border-slate-200/80 transition-all cursor-pointer group flex flex-col justify-between"
          >
            <div>
              <div className="flex items-center justify-between mb-2">
                <span className="text-2xs font-bold text-amber-800 bg-amber-50 px-2 py-0.5 rounded-md border border-amber-100">
                  TCA 2018
                </span>
                <Apple className="w-4 h-4 text-amber-600 group-hover:scale-110 transition-transform" />
              </div>
              <h4 className="font-bold text-xs text-slate-900">Plan Dietético & Costeo</h4>
              <p className="text-xl font-black text-slate-900 mt-1">$21.900 <span className="text-2xs font-bold text-emerald-700 font-sans">COP / día</span></p>
              <p className="text-2xs text-slate-500 mt-1">Meta: <strong>1.720 kcal</strong> • Proteína: <strong>120g</strong></p>
            </div>
            <div className="mt-3 pt-2 border-t border-slate-200 flex items-center justify-between text-2xs font-bold text-amber-700">
              <span>Abrir Plan Nutricional</span>
              <ArrowRight className="w-3.5 h-3.5" />
            </div>
          </div>
        </div>
