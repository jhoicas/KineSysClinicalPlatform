...
import { X, Dumbbell, Clock, Repeat, Calendar, Target, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-xs flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl border border-slate-200 shadow-2xl max-w-2xl w-full overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        {/* Prescription & Clinical Details Body */}
        <div className="p-6 space-y-4">
          ...
          {/* Technical and Biomechanical Instructions */}
