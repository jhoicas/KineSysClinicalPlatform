...
export const HumanBodyVisualizer: React.FC<HumanBodyVisualizerProps> = ({
  ...
  const getBadgeColor = (val: string, normalVal: string) => {
    if (val === normalVal) return '#10B981'; // Green
    if (
      val.includes('leve') ||
      val.includes('Elevado') ||
      val.includes('Elevada') ||
      val.includes('Pronación') ||
      val.includes('Valgo') ||
      val.includes('Anteriorizada') ||
      val.includes('Protracción') ||
      val.includes('Asimetría') ||
      val.includes('Derecha') ||
      val.includes('Izquierda') ||
      val.includes('Flexum')
    ) {
      return '#3B82F6'; // Blue for prominent medical indicator
    }
    return '#EF4444'; // Red for marked alteration
  };
            ...
            <div className="flex flex-col items-center w-full">
              ...
              <div className="relative w-full max-w-[240px] h-[460px] flex items-center justify-center">
                ...
                <button
                  ...
                  style={{
                    backgroundColor: getBadgeColor(posture.anterior.cabeza, 'Alineada'),
                ...
                <button
                  ...
                  style={{
                    backgroundColor: getBadgeColor(posture.anterior.hombros, 'Simétricos'),
                ...
                <button
                  ...
                  style={{ backgroundColor: getBadgeColor(posture.anterior.pelvis, 'Nivelada') }}
                ...
                <button
                  ...
                  style={{
                    ...
                    backgroundColor: getBadgeColor(posture.anterior.rodillas, 'Alineadas'),
                  }}
                ...
                <button
                  ...
                  style={{ backgroundColor: getBadgeColor(posture.anterior.pies, 'Alineados') }}
              ...
              <div className="relative w-full max-w-[240px] h-[460px] flex items-center justify-center">
                ...
                <button
                  ...
                  style={{
                    ...
                    backgroundColor: getBadgeColor(posture.lateral.cabeza, 'Alineada'),
                  }}
                ...
                <button
                  ...
                  style={{
                    ...
                    backgroundColor: getBadgeColor(posture.lateral.hombros, 'Alineados'),
                  }}
                ...
                <button
                  ...
                  style={{ backgroundColor: getBadgeColor(posture.lateral.columnaDorsal, 'Normal') }}
                ...
                <button
                  ...
                  style={{ backgroundColor: getBadgeColor(posture.lateral.columnaLumbar, 'Normal') }}
                ...
                <button
                  ...
                  style={{ backgroundColor: getBadgeColor(posture.lateral.pelvis, 'Neutra') }}
                ...
                <button
                  ...
                  style={{
                    ...
                    backgroundColor: getBadgeColor(posture.lateral.rodillas, 'Neutras'),
                  }}
            ...
            <div className="flex flex-col items-center w-full">
              ...
              <div className="relative w-full max-w-[240px] h-[460px] flex items-center justify-center">
                ...
                <button
                  ...
                  style={{ backgroundColor: getBadgeColor(posture.posterior.escapulas, 'Simétricas') }}
                ...
                <button
                  ...
                  style={{
                    backgroundColor: getBadgeColor(posture.posterior.escapulas, 'Simétricas'),
                ...
                <button
                  ...
                  style={{
                    ...
                    backgroundColor: getBadgeColor(posture.posterior.columna, 'Alineada'),
                  }}
                ...
                <button
                  ...
                  style={{ backgroundColor: getBadgeColor(posture.posterior.pelvis, 'Simétrica') }}
                ...
                <button
                  ...
                  style={{ backgroundColor: getBadgeColor(posture.posterior.talones, 'Alineados') }}
